...
// Data loader
//
// Loads Markdown and JSON files from content/ at build time.
// ============================================================
...
/** Get the content dataset. The language argument is retained for API compatibility. */
export function getLocalizedData(_lang?: string) {
  return enData
}
